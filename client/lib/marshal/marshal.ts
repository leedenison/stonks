...
// neutral format in proto/upload/v1/upload.proto. All knowledge of the
...
import type { Upload } from "@/gen/upload/v1/upload_pb";
...
export interface Marshaller {
  ...
  marshal(text: string, exportedOn: string): Upload;
}
