# A statement claims every account at its broker

A user may hold several accounts at one broker, and a broker's export may cover any of
them. A statement is taken to contain every account the user holds at the claimed broker
over the claimed period.

Replacement is therefore keyed on user, broker and period, not on account. A statement that
