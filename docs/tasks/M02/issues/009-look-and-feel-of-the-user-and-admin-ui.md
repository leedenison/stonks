...
pages. A page that belongs under another, as a statement's page does under the statements,
has a back arrow left of its title leading to that page, whatever the browser's history.
The statements and profile pages are top-level pages and have none. A statement's page is titled by its broker and the moment the upload
