...
func newFixture(t *testing.T) *fixture {
	...
	f.client = statementv1connect.NewStatementServiceClient(client, srv.URL)
	return f
}
...
func TestGetStatement(t *testing.T) {
	rowMsg := &statementv1.Row{Key: &typev1.StatedKey{Description: ptr("ACME")}, OrderDate: "2026-03-05", SettlementDate: "2026-03-07", AsAt: "2026-03-05", Quantity: "10"}
